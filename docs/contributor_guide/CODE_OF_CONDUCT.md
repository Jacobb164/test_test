# Code of conduct for `test_gov`

Contributors to this repository hosted by `ons` are expected to follow the
...
- "Project", we mean this `test_gov` GitHub repository;
- "Maintainer", we mean the `ons` organisation owners; and
- "Leadership", we mean both `ons` organisation owners, line managers, and other
...
[jacob.cole@ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:jacob.cole@ons.gov.uk
